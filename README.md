...
The main functionality of the project can be found in the <i> interface.py </i> and <i href="fr3"> face_recognition.py </i> files, the rest of the files in the repository are the result of tests and implementations that have been carried out during the project until the development of the final program.
